...
export default function Features() {
  ...
  return (
    <section className="relative py-20">
      ...
      Best part for any provider
      </p>
      We Are Here To Hear & Heal Your Financial Health Problems
      <p>
      Doctors can to Set Their Own Price for Back Office Support! We give the freedom to tailor back office support according to providers budgetary constraints.
      </p>
      </div>
        ...
        <div className='px-10 pt-20 pb-4' style={{ backgroundImage: 'url(Images/Authorization.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="p-6 bg-blue-40 rounded-lg"
